...
object HeaderConstants {
    ...
    val GENERIC_HEADER: String = crlf(
...
"""
    ...
    fun forVersion(version: Double): String? = when (version) {
        22.0 -> HEADER_V22
        23.0, 24.0 -> HEADER_V240
        24.1 -> HEADER_V241
        24.2, 24.3, 24.4, 24.5 -> HEADER_V242
        27.0, 27.1, 27.2 -> HEADER_V27
        29.0, 29.1, 31.0 -> HEADER_V29
        else -> null
    }
}
